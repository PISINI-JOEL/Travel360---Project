...
public interface BookingRepository extends JpaRepository<Booking, Long> {
	...
	@Query("SELECT COALESCE(SUM(b.units), 0) FROM Booking b WHERE b.flight.flightId = :flightId AND b.flight.flightDate = :bookingDate AND b.status <> com.cts.enums.BookingStatus.CANCELLED")
   public int getBookedSeats(@Param("flightId") long flightId,
	...
	@Query("SELECT COALESCE(SUM(b.units),0) FROM Booking b " +
		       "WHERE b.transport.transportId = :transportId AND b.status <> com.cts.enums.BookingStatus.CANCELLED")
